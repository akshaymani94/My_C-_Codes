...
// class Derived : private Base //class is derived publically.So all public items of base class will become public for inherited class.
...
We can only call it from inside the class.*/
{
    int data3;
    public:
    void process();
